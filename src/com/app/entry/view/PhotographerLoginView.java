...
import com.app.entry.controller.PhotographerLoginController;
...
public class PhotographerLoginView extends BaseView<PhotographerLoginController> implements EntryButtonCallback, PhotographerLoginController.PhotographerLoginContract {
     ...
     */
    public PhotographerLoginView() {
        mController = new PhotographerLoginController(this);
        initComponents();
        EntryButton.addClickEffect(buttonLogin, "login", this);
    }
    
    @Override
    public PhotographerLoginController createController() {
        return new PhotographerLoginController(this);
    }
    ...
    public void onLoginSuccess() {
        ...
        setVisible(false);        
        ManageAntrianView manageAntrianView = new ManageAntrianView();
        manageAntrianView.setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        labelTitle.setText("Photographer Login");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhotographerLoginView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PhotographerLoginView().setVisible(true);
            }
        });
    }
